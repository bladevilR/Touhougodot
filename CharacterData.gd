...
class Character:
	...
	func _init(cid: int, n: String, t: String, d: String, c: Color, w: String, s: CharacterStats, p: CharacterPhysics):
		id = cid
		char_name = n
		title = t
		description = d
...
static func initialize():
	...
	CHARACTERS[GameConstants.CharacterId.MOKOU] = Character.new(
		...
		CharacterPhysics.new(40, 0.15, 1.0, false, true, true, false)
	)
